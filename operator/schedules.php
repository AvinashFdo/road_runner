            ...
            <div class="form_container mb_2">
                ...
                <form method="POST" action="schedules.php">
                    <input type="hidden" name="action"
                        value="<?php echo $edit_schedule ? 'update_schedule' : 'add_schedule'; ?>">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 1rem;">
                        <div class="form_group">
                            ...
                            <input type="time" id="departure_time" name="departure_time" class="form_control"
                                value="<?php echo $edit_schedule ? $edit_schedule['departure_time'] : ''; ?>" required>
                        </div>

                        <div class="form_group">
                            <label for="arrival_time">Arrival Time:</label>
                            <input type="time" id="arrival_time" name="arrival_time" class="form_control"
                                value="<?php echo $edit_schedule ? $edit_schedule['arrival_time'] : ''; ?>">
                        </div>

                        <div class="form_group">
                            <label for="base_price">Base Price (LKR): *</label>
                            <input type="number" id="base_price" name="base_price" class="form_control"
                                value="<?php echo $edit_schedule ? $edit_schedule['base_price'] : ''; ?>" step="0.01"
                                min="0" placeholder="e.g., 1500.00" required>
                        </div>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                        <div class="form_group">
                            ...
                            <select id="available_days" name="available_days" class="form_control">
                                ...
                                <option value="Weekdays" <?php echo ($edit_schedule && $edit_schedule['available_days'] === 'Weekdays') ? 'selected' : ''; ?>>Weekdays Only
                                </option>
                                <option value="Weekends" <?php echo ($edit_schedule && $edit_schedule['available_days'] === 'Weekends') ? 'selected' : ''; ?>>Weekends Only
                                </option>
                            </select>
                        </div>
                        ...
                        <?php if ($edit_schedule): ?>
                            <div class="form_group">
                                ...
                                <select id="status" name="status" class="form_control">
                                    <option value="active" <?php echo $edit_schedule['status'] === 'active' ? 'selected' : ''; ?>>
                                        Active</option>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <small style="color: #666;">
                                        ...
                                        <span
                                            class="badge badge_<?php echo strtolower(str_replace('-', '', $schedule['bus_type'])); ?>"
                                ...
                                <td>
                                    ...
                                    <?php if ($schedule['arrival_time']): ?>
                                        <small style="color: #666;">to
                                            <?php echo date('g:i A', strtotime($schedule['arrival_time'])); ?></small>
                                    <?php endif; ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span
                                        class="badge badge_<?php echo $schedule['available_days'] === 'Daily' ? 'active' : 'operator'; ?>">
                                        <?php echo $schedule['available_days']; ?>
                                    </span>
                                </td>
                                <td>
                                    <span
                                        class="badge badge_<?php echo $schedule['status'] === 'active' ? 'active' : 'inactive'; ?>">
                                        <?php echo ucfirst($schedule['status']); ?>
                                    </span>
                                </td>
                                <td>
                                    <a href="schedules.php?edit=<?php echo $schedule['schedule_id']; ?>" class="btn btn_primary"
