                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 1rem;">
                    ...
                    <?php if (!$edit_bus): ?>
                        <div class="form_group">
                            ...
                            <input type="number" id="total_seats" name="total_seats" class="form_control" min="10" max="60"
                    ...
                    <?php else: ?>
                        <div class="form_group">
                            ...
                            <input type="text" class="form_control" value="<?php echo $edit_bus['total_seats']; ?>" readonly
                        ...
                        <?php foreach ($buses as $bus): ?>
                            <tr>
                                <td>
                                    ...
                                    <small style="color: #666;">Bus #:
                                        <?php echo htmlspecialchars($bus['bus_number']); ?></small>
                                </td>
                                <td>
                                    <span
                                        class="badge badge_<?php echo strtolower(str_replace('-', '', $bus['bus_type'])); ?>"><?php echo $bus['bus_type']; ?></span><br>
                                    <small><?php echo $bus['actual_seats']; ?>/<?php echo $bus['total_seats']; ?> seats
                                        (<?php echo $bus['seat_configuration']; ?>)</small>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span
                                        class="badge badge_<?php echo $bus['status'] === 'active' ? 'active' : ($bus['status'] === 'maintenance' ? 'operator' : 'inactive'); ?>">
                                        <?php echo ucfirst($bus['status']); ?>
                                    </span>
                                </td>
                                <td>
                                    <a href="buses.php?edit=<?php echo $bus['bus_id']; ?>" class="btn btn_primary"
                                        style="font-size: 0.8rem; padding: 0.25rem 0.5rem;">Edit</a>

                                    <form method="POST" style="display: inline;"
                                        onsubmit="return confirm('Delete this bus and all its seats?');">
