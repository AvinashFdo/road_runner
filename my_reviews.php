...
<head>
    ...
    <title>
        <?php 
        if ($user_type === 'passenger') echo 'My Reviews';
        elseif ($user_type === 'operator') echo 'Bus Reviews';
    ...
    <main class="container">
        ...
        <div class="page-header">
            <h2>
                <?php 
                if ($user_type === 'passenger') echo '⭐ My Reviews';
                elseif ($user_type === 'operator') echo '📊 Reviews for My Buses';
                else echo '🗂️ All System Reviews';
                ?>
            </h2>
            <p>
                <?php 
                if ($user_type === 'passenger') echo 'Manage your trip reviews and feedback';
                elseif ($user_type === 'operator') echo 'Customer feedback for your bus services';
                else echo 'Overview of all customer reviews in the system';
                ?>
            </p>
        </div>
        ...
        <?php if (!empty($reviews)): ?>
            ...
            $five_star = count(array_filter($reviews, function($r) { return $r['rating'] == 5; }));
            $four_plus = count(array_filter($reviews, function($r) { return $r['rating'] >= 4; }));
            ?>
                    ...
                    <div class="review-item">
                        ...
                        <div class="review-meta">
                            ...
                            <?php if ($user_type === 'admin'): ?>
                                ...
                                Bus: <?php echo htmlspecialchars($review['bus_name']); ?> (<?php echo htmlspecialchars($review['bus_number']); ?>) • 
                            <?php elseif ($user_type === 'operator'): ?>
                                Bus: <?php echo htmlspecialchars($review['bus_name']); ?> (<?php echo htmlspecialchars($review['bus_number']); ?>) • 
                            <?php endif; ?>
