    ...
    <main class="search-buses-container">
        <div class="container">
                    ...
                    <div class="search_form_grid">
                        ...
                        <div class="form_group">
                            ...
                            <input type="text" id="destination" name="destination" class="form_control"
                                value="<?php echo htmlspecialchars($destination); ?>" placeholder="e.g., Kandy"
                                required>
                        </div>
                    ...
                    <div class="features_grid">
                        <?php foreach ($popular_routes as $route): ?>
                            <div class="feature_card">
                                ...
                                <p><?php echo htmlspecialchars($route['origin']) . ' → ' . htmlspecialchars($route['destination']); ?>
                                </p>
                                <button
                                    onclick="fillRoute('<?php echo addslashes($route['origin']); ?>', '<?php echo addslashes($route['destination']); ?>')"
            ...
            <?php if ($search_performed): ?>
                <div class="mb_2">
                    <h3 class="mb_1">
                        Search Results: <?php echo htmlspecialchars($origin); ?> →
                        <?php echo htmlspecialchars($destination); ?>
                        <small
                            style="color: #666; font-weight: normal;">(<?php echo date('D, M j, Y', strtotime($travel_date)); ?>)</small>
                    </h3>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <small style="color: #666;">
                                                    ...
                                                    <span
                                                        class="badge badge_<?php echo strtolower(str_replace('-', '', $bus['bus_type'])); ?>"
                                                        style="font-size: 0.7rem;">
                                                        <?php echo $bus['bus_type']; ?>
                                                    </span>
                                                </small><br>
                                                <small style="color: #888;">by
                                                    <?php echo htmlspecialchars($bus['operator_name']); ?></small>
                                            </td>
                                            <td>
                                                ...
                                                <?php if ($bus['estimated_duration']): ?>
                                                    <small style="color: #666;">Duration:
                                                        <?php echo htmlspecialchars($bus['estimated_duration']); ?></small><br>
                                                <?php endif; ?>
                                                <small style="color: #666;">Distance: <?php echo $bus['distance_km']; ?> km</small>
                                            </td>
                                            <td>
                                                <div
                                                    style="font-size: 1.2rem; font-weight: bold; color: #e74c3c; margin-bottom: 0.5rem;">
                                            ...
                                            <td>
                                                <?php if ($bus['available_seats'] > 0): ?>
                                                    <a href="seat_selection.php?schedule_id=<?php echo $bus['schedule_id']; ?>&travel_date=<?php echo urlencode($travel_date); ?>"
                                                        class="btn btn_primary" style="font-size: 0.9rem; padding: 0.5rem 1rem;">
                                                        Select Seats
                                                    </a>
                                                <?php else: ?>
