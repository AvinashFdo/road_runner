            ...
            <form method="POST" action="routes.php">
                ...
                <div class="form_group">
                    ...
                    <input 
                        ...
                        placeholder="e.g., Colombo to Kandy Express"
                        required
                    >
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div class="form_group">
                        ...
                        <input 
                            ...
                            name="distance_km" 
                            class="form_control" 
                            value="<?php echo $edit_route ? $edit_route['distance_km'] : ''; ?>"
                            step="0.1"
                            min="0"
                ...
                <div class="form_group">
                    ...
                    ><?php echo $edit_route ? htmlspecialchars($edit_route['route_description']) : ''; ?></textarea>
                </div>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <?php if ($route['route_description']): ?>
                                        <br><small style="color: #666;"><?php echo htmlspecialchars($route['route_description']); ?></small>
                                    <?php endif; ?>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span class="badge badge_<?php echo $route['status'] === 'active' ? 'active' : 'inactive'; ?>">
                                        <?php echo ucfirst($route['status']); ?>
                                    </span>
                                </td>
                                <td>
                                    <a href="routes.php?edit=<?php echo $route['route_id']; ?>" class="btn btn_primary" style="font-size: 0.8rem; padding: 0.25rem 0.5rem;">Edit</a>
