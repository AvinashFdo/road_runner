...
try {
    ...
    $booking_stats_sql = "
        ...
        FROM bookings
    ";
    $booking_stats = $pdo->query($booking_stats_sql)->fetch();
    ...
    $parcel_stats_sql = "
        SELECT 
            ...
            SUM(delivery_cost) as total_parcel_revenue
        FROM parcels
    ";
    $parcel_stats = $pdo->query($parcel_stats_sql)->fetch();
    ...
    ";
    $bookings = $pdo->query($bookings_sql)->fetchAll();

    // Get all parcels with related information
    $parcels_sql = "
        SELECT 
            p.*,
    ...
    ";
    $parcels = $pdo->query($parcels_sql)->fetchAll();
...
<head>
    ...
    <title>View All Bookings - Road Runner Admin</title>
...
<body>
    ...
    <main class="container">
        <h2 class="mb_2">📋 View All Bookings & Parcels</h2>
        ...
        <div class="dashboard_grid mb_2">
            <div class="stat_card">
                ...
                <div class="stat_label">Total Bus Bookings</div>
            </div>
            <div class="stat_card">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin: 2rem 0;">
            ...
            <div class="table_container">
                <h3 class="p_1 mb_1">🚌 Bus Booking Status</h3>
            ...
            <div class="table_container">
                <h3 class="p_1 mb_1">📦 Parcel Status</h3>
                <div style="padding: 1rem;">
                    <div
                        style="display: flex; justify-content: space-between; margin-bottom: 1rem; padding: 0.5rem; background: #f8f9fa; border-radius: 4px;">
                        <span class="badge badge_pending">Pending</span>
                    ...
                    <div
                        style="display: flex; justify-content: space-between; margin-bottom: 1rem; padding: 0.5rem; background: #f8f9fa; border-radius: 4px;">
                        <span class="badge badge_operator">In Transit</span>
                        <strong><?php echo $parcel_stats['in_transit_parcels']; ?> parcels</strong>
                    </div>
                    <div
                        style="display: flex; justify-content: space-between; margin-bottom: 1rem; padding: 0.5rem; background: #f8f9fa; border-radius: 4px;">
                        <span class="badge badge_completed">Delivered</span>
        ...
        <div class="tab_container">
            <div class="tab_buttons">
                ...
                <button class="tab_button" onclick="switchTab('parcels')">📦 Parcels
            ...
            <div id="bookings" class="tab_content active">
                <div class="table_container">
                    <h3 class="p_1 mb_1">All Bus Bookings</h3>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Booking ID</th>
                    ...
                    <?php if (empty($bookings)): ?>
                        <div style="padding: 2rem; text-align: center; color: #666;">
                            <p>No bus bookings found in the system.</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div id="parcels" class="tab_content">
                <div class="table_container">
                    <h3 class="p_1 mb_1">All Parcels</h3>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Parcel ID</th>
                    ...
                    <?php if (empty($parcels)): ?>
                        <div style="padding: 2rem; text-align: center; color: #666;">
                            <p>No parcels found in the system.</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
