        ...
        <div class="payment-container">
            ...
            <div class="booking-summary">
                ...
                <div style="margin-bottom: 1rem;">
                    ...
                    <strong>Bus:</strong> <?php echo htmlspecialchars($booking_data['bus_name']); ?>
                    (<?php echo htmlspecialchars($booking_data['bus_number']); ?>)
                </div>
                ...
                <?php foreach ($booking_data['passengers'] as $index => $passenger): ?>
                    <div class="passenger-item">
                        <span><?php echo htmlspecialchars($passenger['name']); ?>
                            (Seat
                            <?php echo isset($passenger['seat_number']) ? htmlspecialchars($passenger['seat_number']) : ($index + 1); ?>)</span>
            ...
            <form method="POST" id="paymentForm">
                ...
                <div class="payment-option" onclick="selectPaymentMethod('pay_later')">
                    ...
                    <label for="pay_later" style="cursor: pointer; font-size: 1.1rem;">
                        ...
                        <p style="margin: 0.5rem 0; color: #666;">Book your seats now and pay at the bus station before
                            departure.</p>
                        <small style="color: #e74c3c;">Note: Seats will be held for 2 hours. Payment required before
                            travel.</small>
                    </label>
                </div>
