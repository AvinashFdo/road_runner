            ...
            <div class="parcel-summary">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1rem;">
                    <div>
                        ...
                        <strong>Delivery Date:</strong> <?php echo date('D, M j, Y', strtotime($parcel_data['travel_date'])); ?>
                    </div>
                    <div>
            ...
            <form method="POST" id="paymentForm">
                ...
                <div class="payment-option" onclick="selectPaymentMethod('pay_later')">
                    ...
                    <label for="pay_later" style="cursor: pointer; font-size: 1.1rem;">
                        ...
                        <p style="margin: 0.5rem 0; color: #666;">Book your parcel now and pay when you drop it off at the origin station.</p>
                        <small style="color: #e74c3c;">Note: Payment required before parcel is accepted for transport.</small>
                    </label>
                </div>
                ...
                <div id="cardForm" class="card-form">
                    ...
                    <div class="form_group">
                        ...
                        <input type="text" id="cardholder_name" name="cardholder_name" class="form_control" placeholder="John Doe">
                    </div>
